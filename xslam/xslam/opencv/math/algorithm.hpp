#ifndef XSLAM_OPENCV_MATH_ALGORITHM_HPP
#define XSLAM_OPENCV_MATH_ALGORITHM_HPP
 ...
 */
template <typename T>
inline void kernel_region (T const& cx, T const& cy, T const& ks,
...
#endif // XSLAM_OPENCV_MATH_ALGORITHM_HPP