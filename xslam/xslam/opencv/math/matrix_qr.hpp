#ifndef XSLAM_OPENCV_MATH_MATRIX_QR_HPP
#define XSLAM_OPENCV_MATH_MATRIX_QR_HPP
...
template <typename T>
void matrix_qr (T const* mat_a, int rows, int cols,
...
#endif // XSLAM_OPENCV_MATH_MATRIX_QR_HPP