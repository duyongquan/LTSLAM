/*
 * @Author: your name
 * @Date: 2022-08-10 17:14:05
 * @LastEditTime: 2022-08-10 17:23:38
 * @LastEditors: quan-Blade-15-Mid-2019-Base
 * @Description: In User Settings Edit
 * @FilePath: /LTSLAM/xslam/xslam/opencv/math/matrix_svd.hpp
 */

#ifndef XSLAM_OPENCV_MATH_MATRIX_SVD_HPP
#define XSLAM_OPENCV_MATH_MATRIX_SVD_HPP

#include <vector>

#include "xslam/opencv/math/defines.h"
#include "xslam/opencv/math/matrix.h"
#include "xslam/opencv/math/matrix_tools.h"
#include "xslam/opencv/math/matrix_qr.h"
 ...
 */
template <typename T>
void matrix_svd (T const* mat_a, int rows, int cols,
 ...
 */
template <typename T, int M, int N>
void matrix_pseudo_inverse (Matrix<T, M, N> const& A,
    Matrix<T, N, M>* result,
    T const& epsilon = T(MATH_SVD_DEFAULT_ZERO_THRESHOLD));
 ...
 */
template <typename T>
bool matrix_is_superdiagonal_nonzero (T const* mat,
 ...
 */
template <typename T>
void matrix_householder_vector (T const* input, int length,
 ...
 */
template <typename T>
void matrix_gk_svd_step (int rows, int cols, T* mat_b, T* mat_q, T* mat_p,
 ...
 */
template <typename T>
void matrix_gk_svd (T const* mat_a, int rows, int cols,
 ...
 */
template <typename T>
void matrix_r_svd (T const* mat_a, int rows, int cols,
    T* mat_u, T* vec_s, T* mat_v, T const& epsilon)
{
    /* Allocate memory for temp matrices. */
...
#endif // XSLAM_OPENCV_MATH_MATRIX_SVD_HPP