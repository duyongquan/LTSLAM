...
void SFMGlobal::RunDemo(const std::string& filename)
{
    ...
    printf("X-SLAM Tutorial: # of 3D points: %zd\n", Xs.size());
    ...
    printf("X-SLAM Tutorial: # of 3D points: %zd (Rejected: %d)\n", Xs.size(), num_noisy);
...
std::vector<bool> SFMGlobal::maskNoisyPoints(
    std::vector<cv::Point3d>& Xs,
