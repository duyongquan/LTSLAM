#ifndef TUTORIAL_COMMON_LOG_LOG_HPP
#define TUTORIAL_COMMON_LOG_LOG_HPP
...
/**
 * Logging categories and verbosity can be specified dynamically at runtime.
...
private:
    ...
    static void get_timestamp(std::string&);
};
...
#define logError_(cat, msg)                                                                                            \
    {                                                                                                                  \
        using namespace tutorial::common::log;                                                                        \
...
#endif // ifndef TUTORIAL_COMMON_LOG_LOG_HPP
